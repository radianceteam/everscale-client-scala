...
class AbiModuleTest extends AnyFlatSpec with TestBase {
  ...
  "5" should "be equal" in {
    unsigned1.message shouldBe "te6ccgEBAgEAeAABpYgAC31qq9KF9Oifst6LU9U6FQSQQRlCSEMo+A3LN5MvphIFMfECP8d3ruNZAXul5xxahT91swIEkEHph08JVlwmUmQAAAXRnJcuDX1XMZBW+LBKAQBAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="
  }
  ...
  "7" should "be equal" in {
    signature1 shouldBe "5bbfb7f184f2cb5f019400b9cd497eeaa41f3d5885619e9f7d4fab8dd695f4b3a02159a1422996c1dd7d1be67898bc79c6adba6c65a18101ac5f0a2a2bb8910b"
  }

  "8" should "be equal" in {
    signed1.message shouldBe ""
  }

  "9" should "be equal" in {
    signed2.message shouldBe ""
  }

  "10" should "be equal" in {
    noPubkey.message shouldBe "te6ccgEBAQEAVQAApYgAC31qq9KF9Oifst6LU9U6FQSQQRlCSEMo+A3LN5MvphIAAAAC6M5Llwa+q5jIK3xYJAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAB"
  }
}
